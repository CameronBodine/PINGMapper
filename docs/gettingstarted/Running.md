...
sonPath = "C:/user/cam/myHumDat" # Path to folder containing .SON and .IDX files
...
### Step 3
- Enter paths to .DAT file, folder containing .SON and .IDX files, and output directory:
```
humFile = "C:/user/cam/myHumDat.DAT" # Path to sonar recording .DAT file
sonPath = "C:/user/cam/myHumDat" # Path to folder containing .SON and .IDX files
projDir = "C:/user/cam/myHumAnswerBox/myHumDat" # Directory where you want to export files
...
### Step 7
Update segmentation prameters as necessary:
...
2. Option to mosaic georectified sonar imagery (exported from step 12). Options include:
